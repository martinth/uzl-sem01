 ...
 */
public class PhoneBookRESTServer {

	private static final Logger log = LoggerFactory.getLogger(PhoneBookRESTServer.class);
	...
	public static void main(String[] args) throws Exception {
		...
		sa.addServletListener(PhoneBookRESTServerConfig.class.getName());
